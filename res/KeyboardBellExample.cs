...
public class KeyboardBell : AudioBaseType
{
	...
	public override void MidiPitchBendState(int velocity)
	{
	
	}

	public override void MidiModWheelState(int velocity)
	{	
	
	}

	public override void MidiVolumeSliderState(int velocity)
	{			
